...
public class chéques_entrants extends javax.swing.JFrame {
    ResultSet rs;
    db_connection db;
    
    public chéques_entrants() {
    ...
    public void date() {
     ...
     public void table() {
        ...
        rs = db.querySelect(a, "chéques_entrants");
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(240, 260, 1090, 440);

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Photos/couverture.png"))); // NOI18N
        getContentPane().add(jLabel13);
        jLabel13.setBounds(0, -30, 1390, 210);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "CHEQUES ENTRANTS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 20))); // NOI18N
        ...
        comrech_ce.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "date", "id", "mat_fiscale", "RIB", "date d'échéance", "montant", "bank" }));
        jPanel3.add(comrech_ce);
        comrech_ce.setBounds(30, 40, 110, 30);
        ...
        txtrech_ce.setBounds(30, 80, 110, 30);
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 280, 190, 230);
        ...
        jButton1.setBounds(20, 30, 170, 40);
        ...
        jButton2.setBounds(20, 70, 170, 40);
        ...
        jButton4.setBounds(20, 110, 170, 40);
        ...
        jButton5.setBounds(20, 150, 170, 40);
        ...
        jButton3.setBounds(20, 190, 170, 40);
        ...
        jButton6.setBounds(20, 230, 170, 40);
        ...
        jPanel7.add(jLabel2);
        jLabel2.setBounds(510, 20, 120, 34);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel4.setText("Date d'échéance : ");
        jPanel7.add(jLabel4);
        jLabel4.setBounds(60, 60, 150, 34);

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel8.setText("Chèque daté : ");
        jPanel7.add(jLabel8);
        jLabel8.setBounds(320, 60, 120, 34);
        ...
        txtdat_ce.setBounds(420, 60, 110, 30);

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel7.setText("Bank : ");
        jPanel7.add(jLabel7);
        jLabel7.setBounds(810, 60, 80, 34);
        jPanel7.add(txtbank_ce);
        txtbank_ce.setBounds(860, 60, 110, 30);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel6.setText("Montant :");
        jPanel7.add(jLabel6);
        jLabel6.setBounds(590, 60, 98, 34);
        jPanel7.add(txtmont_ce);
        txtmont_ce.setBounds(660, 60, 110, 30);

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel9.setText("Id : ");
        jPanel7.add(jLabel9);
        jLabel9.setBounds(310, 20, 40, 34);
        jPanel7.add(txtdatéch_ce);
        txtdatéch_ce.setBounds(190, 60, 110, 30);
        jPanel7.add(txtRIB_ce);
        txtRIB_ce.setBounds(830, 20, 110, 30);
        jPanel7.add(txtmatf_ce);
        txtmatf_ce.setBounds(610, 20, 110, 30);

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel11.setText("RIB :");
        jPanel7.add(jLabel11);
        jLabel11.setBounds(790, 20, 98, 34);

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel10.setText("Date :");
        jPanel7.add(jLabel10);
        jLabel10.setBounds(90, 30, 60, 19);
        ...
        jPanel7.setBounds(240, 160, 1090, 100);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       if (txtdate.getText().equals("") ||txtid_ce.getText().equals("") || txtmatf_ce.getText().equals("")
            ...
            System.out.println(db.queryInsert("chéques_entrants", colon, inf));
            table();
            actualiser();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // modifier
          if (txtdate.getText().equals("") ||txtid_ce.getText().equals("") || txtmatf_ce.getText().equals("") || txtRIB_ce.getText().equals("")
            ...
            System.out.println(db.queryUpdate("chéques_entrants", colon, inf, "id='" + id + "'"));
            table();
            actualiser();
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "est ce que tu es sure que tu veux suuprimer", "attention!!!", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            db.queryDelete("chéques_entrants", "id=" + id);
        } else {
            return;
        }
        table();
    ...
    private void chercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chercherActionPerformed
        if (txtrech_ce.getText().equals("")) {
            ...
            if (comrech_ce.getSelectedItem().equals("date")) {
                rs = db.querySelectAll("chéques_entrants", "date LIKE '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));
            } else if (comrech_ce.getSelectedItem().equals("mat_fiscale")) {
                rs = db.querySelectAll("chéques_entrants", "mat_fiscale '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));}
            else if (comrech_ce.getSelectedItem().equals("RIB")) {
                rs = db.querySelectAll("chéques_entrants", "RIB LIKE '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));
            } else if (comrech_ce.getSelectedItem().equals("date d'échéance")) {
                rs = db.querySelectAll("chéques_entrants", "date_échéance LIKE '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));
            } else if (comrech_ce.getSelectedItem().equals("montant")) {
                rs = db.querySelectAll("chéques_entrants", "montant LIKE '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));
            } else if (comrech_ce.getSelectedItem().equals("bank")) {
                rs = db.querySelectAll("chéques_entrants", "bank LIKE '%" + txtrech_ce.getText() + "%' ");
                table_ce.setModel(new ResultSetTableModel(rs));
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chéques_entrants().setVisible(true);
            }
        });
    }
